...
| --- | --- |
| Captured live prompt, command, resource, duration, Unknown Event, parallel reviewer activity, history-only attribution, evaluation isolation, export | `replays the captured 0.145.0 code-review fixture through the black-box boundary` |
